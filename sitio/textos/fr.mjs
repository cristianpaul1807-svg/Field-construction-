...
export default {
  ...
  contacto: {
    ...
    primeroP:
      "La barre du bas, sur tous les écrans. Elle connaît les taxes, la retenue, la CCQ et la paie, et elle vous amène à l'endroit où ça se fait. Si sa réponse ne règle pas votre cas, elle ouvre un billet elle-même — avec votre entreprise et l'écran où vous étiez déjà dedans.",
